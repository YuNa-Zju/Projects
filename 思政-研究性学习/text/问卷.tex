...
\begin{enumerate}[label=第\arabic{*}题、, leftmargin=7em]
    ...
    \begin{figure}[H]
        \centering
        \subfigure[A选项图]{\includegraphics[width=0.15\textwidth]{./assets/T2-1.jpg}}
        \subfigure[B选项图]{\includegraphics[width=0.15\textwidth]{./assets/T2-2.jpg}}
        \subfigure[C选项图]{\includegraphics[width=0.15\textwidth]{./assets/T2-3.jpg}}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \subfigure[A选项图]{\includegraphics[width=0.15\textwidth]{./assets/T2-4.jpg}}
        \subfigure[B选项图]{\includegraphics[width=0.15\textwidth]{./assets/T2-5.jpg}}
        \subfigure[C选项图]{\includegraphics[width=0.15\textwidth]{./assets/T2-6.jpg}}
    \end{figure}
